document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if ((type === 'tel' || name.toLowerCase().includes('phone') || name.toLowerCase().includes('tel')) && value !== '') {
        ...
        if (field.hasAttribute('minlength')) {
          ...
          if (value.length < minLength) {
            fieldValid = false;
            errorMessage = field.dataset.errorMinlength || 'Minimum length is ' + minLength + ' characters.';
          }
        }
        ...
        if (field.hasAttribute('maxlength')) {
          ...
          if (value.length > maxLength) {
            fieldValid = false;
            errorMessage = field.dataset.errorMaxlength || 'Maximum length is ' + maxLength + ' characters.';
          }
        }
      }
  ...
  function showFormSuccess(form) {
    ...
    statusEl.className = 'form-status form-status--success';
    statusEl.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'd1cdac4f-cf64-45bc-aed2-f618b66ceed0',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'd1cdac4f-cf64-45bc-aed2-f618b66ceed0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd1cdac4f-cf64-45bc-aed2-f618b66ceed0';
